...
var Shake1 = new ShakeModel("rejoy", "בננה, ממרח אגוזי לוז, regurt, חלב", 28, 25, 24);

//ShakeName = "rejoy", ShakeDescription = "בננה, ממרח אגוזי לוז, regurt, חלב", PriceSizeL = 31,
//    PriceSizeM = 27, PriceSizeS = 24 };
